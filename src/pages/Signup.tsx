        ...
        <div className="flex h-screen w-screen items-center justify-center bg-gray-100">
            <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
                ...
                <div className="mb-6 text-center">
                    ...
                    <p className="mt-2 text-slate-600">Sign up to manage your tasks efficiently</p>
                </div>
                ...
                <form>
                    ...
                    <div className="mb-6">
                        <label className="mb-2 block font-medium text-gray-700" htmlFor="password">Password</label>
                        <input
                            className="w-full rounded-lg border border-gray-300 p-3 focus:border-blue-500 focus:outline-none"
                            type="password"
                            id="password"
                    ...
                    <button className="w-full rounded-lg bg-green-600 py-3 text-white transition hover:bg-green-700" type="submit">Sign Up</button>
                </form>
                {/* OR Divider */}
                ...
                <div className="mt-6 text-center text-sm text-gray-500">
                    ...
                    <p className="mt-2"><a href="#" className="text-gray-500 hover:underline">Privacy Policy</a> &middot; <a href="#" className="text-gray-500 hover:underline">Terms of Service</a></p>
                </div>
            </div>
        </div>
    );
